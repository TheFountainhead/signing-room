            ...
            @if($rejected)
                <div style="margin-bottom: 24px;">
                    <svg viewBox="0 0 120 120" width="96" height="96" style="margin: 0 auto;">
                        <circle cx="60" cy="60" r="56" fill="#FDECEA" stroke="#C0392B" stroke-width="2"/>
                        <path d="M42 42 L78 78 M78 42 L42 78" stroke="#C0392B" stroke-width="5" fill="none" stroke-linecap="round"/>
                    </svg>
                </div>

                <h1 style="font-size: 2rem; margin-bottom: 16px;">Dokument afvist</h1>

                <p style="color: var(--ft-dark); margin-bottom: 8px; font-size: 1.125rem; line-height: 1.7;">
                    Din afvisning er registreret.
                </p>
                <p style="color: var(--ft-grey); margin-bottom: 32px;">
                    Afsenderen er blevet informeret og kan kontakte dig, hvis der er behov for ændringer.
                </p>
            @else
                <div style="margin-bottom: 24px;">
                    <svg viewBox="0 0 120 120" width="96" height="96" style="margin: 0 auto;">
